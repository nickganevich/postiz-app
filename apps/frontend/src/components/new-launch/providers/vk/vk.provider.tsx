    ...
    <div className="flex flex-col gap-[16px]">
      ...
      {postType === 'clip' && (
        <div className="text-[12px] text-customColor18">
          Клип — ровно одно видео mp4, публикуется как видео в сообществе,
          НЕ как запись на стене. VK сам показывает вертикальные короткие
          видео в разделе «Клипы»; отдельного метода публикации туда нет.
        </div>
      )}
